...
//                FilteredInvoiceResp.builder().senderId(senderId).total(BigDecimal.valueOf(100)).build()
//        );
//
//        when(invoiceViewService.getSentInvoicesByTaxId(taxId, any())).thenReturn(mockInvoices);
//
//        mockMvc.perform(get("http://invoice-service:8080/api/invoice/view/sent/{taxId}", taxId)
//                        .contentType(MediaType.APPLICATION_JSON))
//                .andExpect(status().isOk())
//                .andExpect(jsonPath("$[0].senderId").value(senderId.toString()))
//                .andExpect(jsonPath("$[0].total").value(BigDecimal.valueOf(100)));
//    }
//
//    @Test
...
//
//        List<FilteredInvoiceResp> mockInvoices = List.of(
//                FilteredInvoiceResp.builder().customerId(customerId).total(BigDecimal.valueOf(200)).build()
//        );
//
//        when(invoiceViewService.getReceivedInvoicesByTaxId(taxId, any())).thenReturn(mockInvoices);
//
//        mockMvc.perform(get("/http://invoice-service:8080/api/invoice/view/received/{taxId}", taxId)
//                        .contentType(MediaType.APPLICATION_JSON))
//                .andExpect(status().isOk())
//                .andExpect(jsonPath("$[0].customerId").value(customerId.toString()))
//                .andExpect(jsonPath("$[0].total").value(BigDecimal.valueOf(200)));
//    }
//
//    @Test
...
//                Invoice.builder().id(UUID.randomUUID()).senderId(senderId).total(BigDecimal.valueOf(50)).build()
//        );
//
...
//                .andExpect(status().isOk())
//                .andExpect(jsonPath("$[0].senderId").value(senderId.toString()))
//                .andExpect(jsonPath("$[0].total").value(BigDecimal.valueOf(50)));
//    }
//
//    @Test
...
//
//        List<Invoice> mockInvoices = List.of(
//                Invoice.builder().id(UUID.randomUUID()).senderId(senderId).total(BigDecimal.valueOf(150)).build()
//        );
//
...
//                .andExpect(status().isOk())
//                .andExpect(jsonPath("$[0].senderId").value(senderId.toString()))
//                .andExpect(jsonPath("$[0].total").value(BigDecimal.valueOf(150)));
//    }
}
