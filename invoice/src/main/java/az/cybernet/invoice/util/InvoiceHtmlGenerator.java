        ...
        return String.format("""
            ...
            <head>
                ...
                <style>
                    ...
                    .header { text-align: center; font-size: 18px; font-weight: bold; padding: 12px; }
                    .summary { text-align: right; padding: 10px; font-weight: bold; }
                </style>
            </head>
            <body>
            <table>
                <tr><td colspan="2" class="header">ELEKTRON QAİMƏ-FAKTURA</td></tr>
                <tr><td><b>Tarix:</b></td><td>%s</td></tr>
                <tr><td><b>SERİYA:</b></td><td>%s</td></tr>
                <tr><td><b>№:</b></td><td>%s</td></tr>
                <tr><td><b>TƏQDİM EDƏN VÖEN:</b></td><td>%s</td></tr>
                <tr><td><b>ALICI VÖEN:</b></td><td>%s</td></tr>
            </table>
            <br>
            <table>
                <tr>
            ...
            <div class="signature">
                ...
                <div><div class="bold">MÜŞTƏRİ: </div><br><br>İmza ___________________________</div>
            </div>
            </body>
            </html>
            """,
